...
const RNGBlockhashLocalhost = require("@pooltogether/pooltogether-rng-contracts/deployments/localhost_1/RNGBlockhash.json");
...
const config = {
  ...
  namedAccounts: {
    ...
    rng: {
      ...
      31337: RNGBlockhashLocalhost.address,
    },
    admin: {
      42: testnetAdmin,
      4: testnetAdmin,
